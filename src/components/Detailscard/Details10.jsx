      ...
      <div className="containers">
        <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
          <div class="col d-flex flex-column align-items-start gap-2">
            ...
            Manali, where the exhilarating adventures and profound friendships in "Yeh Jawaani Hai Deewani" take center stage. Explore the scenic beauty of the Himalayan town, trek in the lush valleys, and live the spirit of freedom. Just as the characters in the film forged unforgettable bonds, let Manali be the backdrop for your own adventure-filled journey. Manali, where the mountains echo with the sounds of youthful enthusiasm and lifelong memories.            </p>
          </div>
