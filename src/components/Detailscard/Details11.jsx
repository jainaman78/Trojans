      ...
      <div className="containers">
        <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
          <div class="col d-flex flex-column align-items-start gap-2">
            ...
            Darjeeling, much like the charming setting of "Barfi," offers a whimsical escape into the hills. Stroll through misty tea plantations, take in panoramic views of the Himalayas, and explore the quaint town's vintage charm. Experience the magic of love and friendship in the backdrop of this picturesque hill station, just like the characters in the film. Darjeeling, where every moment is a sweet and unforgettable melody.            </p>
          </div>
