      ...
      <div className="containers">
        <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
          <div class="col d-flex flex-column align-items-start gap-2">
            ...
            Kashmir, the mesmerizing backdrop of "Fitoor," is a place of intense passion and poetic beauty. Witness the breathtaking landscapes, including the Dal Lake and the Mughal Gardens, and be captivated by the film's tale of love and obsession. Just as the characters' lives intertwine in the valleys of Kashmir, let this enchanting land kindle your own sense of longing and desire. Kashmir, where love is as wild and untamed as the landscapes that surround it.            </p>
          </div>
