      ...
      <div className="containers">
        <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
          <div class="col d-flex flex-column align-items-start gap-2">
            ...
            Chennai, a city as vibrant and lively as the Bollywood blockbuster "Chennai Express." Get ready for a thrilling ride through the cultural and scenic wonders of the city. Explore the bustling markets, savor the mouthwatering South Indian cuisine, and immerse yourself in the warmth of Chennai's people, just like the characters in the film. Chennai, where every moment is a cinematic adventure!            </p>
          </div>
