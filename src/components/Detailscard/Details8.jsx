      ...
      <div className="containers">
        <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
          <div class="col d-flex flex-column align-items-start gap-2">
            ...
            Amritsar, like the heartwarming love story in "Rab Ne Bana Di Jodi," is a city that celebrates tradition and love. Visit the iconic Golden Temple, soak in the spirituality, and experience the vibrant Punjabi culture. Just as the film's protagonist transforms, let Amritsar transform your heart with its warmth and charm. Amritsar, where love and tradition blend seamlessly.            </p>
          </div>
