      ...
      <div className="containers">
        <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
          <div class="col d-flex flex-column align-items-start gap-2">
            ...
            Goa, a stage as vibrant and dramatic as the character's journey in "Dear Zindagi." Here, you can immerse yourself in the sweeping vistas, confront your innermost thoughts, and experience the profound self-discovery, just like the film's protagonist. Goa, where every twist and turn becomes a powerful act in the theater of life, celebrating the drama of self-realization.            </p>
          </div>
